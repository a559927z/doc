...
public interface HumanInventoryDao {
	 ...
	 * @param year
	 */
	public List<HumanInventoryChartDto> getProjectNum(@Param("customerId") String customerId,
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year);
	 ...
	 * @param year
	 */
	public List<HumanInventoryChartDto> getProjectLoadNum(@Param("customerId") String customerId,@Param("organId") String organId,
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year);
	...
	public List<HumanInventoryChartDto> queryInputOutputAmount(@Param("customerId") String customerId,
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year, @Param("quarter") String quarter);
	...
	public List<HumanInventoryChartDto> getProfitAndLossCountAmount(@Param("customerId") String customerId,
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year, @Param("month") String month);
	...
	public int findCurrentEmployeeCount(Map<String, Object> map);

	/**
	 * 当前人力投入
	 */
	public List<HumanInventoryDto> findCurrentEmployee(Map<String, Object> map);

	/**
	 * 人力投入环比趋势
	 */
	public List<HumanInventoryDto> queryManpowerInputByMonth(Map<String, Object> map);
	 ...
	 * @return
	 */
	public List<HumanInventoryDto> queryInputOutputByMonth(Map<String, Object> map);
	 ...
	 * @return
	 */
	public HumanInventoryDto queryInputOutputByYear(Map<String, Object> map);
	 ...
	 * @param year
	 */
	public List<HumanInventoryDto> getDepartmentInput(Map<String, Object> map);
	 ...
	 * @param year
	 */
	public List<HumanInventoryDto> getJobSeqInput(Map<String, Object> map);
	 ...
	 * @param year
	 */
	public List<HumanInventoryDto> getRankInput(Map<String, Object> map);
	 ...
	 * @param year
	 */
	public List<HumanInventoryDto> getWorkplaceInput(Map<String, Object> map);
	 ...
	 * 项目表获取时间区间
	 * */
	String queryDates(@Param("customerId") String customerId, @Param("subOrganIdList") List<String> subOrganIdList);
	
	/**
	 * 明细分析-本年利润
	 * */
	List<HumanInventoryChartDto> queryProfitByYear(Map<String, Object> map);
	
	/**
	 * 明细分析-本年主导项目信息
	 * */
	List<HumanInventoryChartDto> queryLeadingProjectInfo(@Param("customerId") String customerId, 
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year);
	
	/**
	 * 明细分析-本年参与项目信息
	 * */
	List<HumanInventoryChartDto> queryPartakeProjectInfo(@Param("customerId") String customerId, 
			@Param("subOrganIdList") List<String> subOrganIdList, @Param("year") String year);
}
