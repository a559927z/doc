...
public class HumanInventoryServiceImpl implements HumanInventoryService {
    ...
    public Map<String, Object> getProjectConAndAvgNum(String customerId, String organId, String year) {
        ...
        List<HumanInventoryChartDto> list = humanInventoryDao.getProjectConAndAvgNum(customerId, subOrganIdList, year);
    ...
    public Map<String, Object> getProjectInputOutputNum(String customerId, String organId, String year) {
        Map<String, Object> map = CollectionKit.newMap();
        List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.getProjectInputOutputNum(customerId, subOrganIdList, year);
    ...
    public Map<String, Object> getProjectLoadNum(String customerId, String organId, String year) {
        List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.getProjectLoadNum(customerId, organId, subOrganIdList, year);
        double loadNum = 0d;
        if (list != null && list.size() > 0) {
    ...
    public PaginationDto<HumanInventoryDto> getCurrentEmployeeList(String customerId, String organId, String projectId,
    	...
    	if(!StringUtils.isEmpty(time)){
    		...
    		year = null;
        	minDate = times[0] + (Integer.parseInt(times[1]) < 10 ? "0" + times[1] : times[1]);
        	maxDate = times[2] + (Integer.parseInt(times[3]) < 10 ? "0" + times[3] : times[3]);
    	}
    	RowBounds rowBounds = new RowBounds(dto.getOffset(), dto.getLimit());
    	...
    	pMap.put("year", year);
    	pMap.put("minDate", minDate);
    	pMap.put("maxDate", maxDate);
        int count = humanInventoryDao.findCurrentEmployeeCount(pMap);
        List<HumanInventoryDto> list = humanInventoryDao.findCurrentEmployee(pMap);
        dto.setRecords(count);
        dto.setRows(list);
        return dto;
    }
     ...
     */
    @Override
    public List<HumanInventoryDto> queryManpowerInputByMonth(String customerId, String organId, String projectId, String time) {
    	String year = DateUtil.getDBNow().substring(0, 4);
    	String minDate = null, maxDate = null;
    	if(!StringUtils.isEmpty(time)){
    		String[] times = time.split(",");
    	...
    	pMap.put("minDate", minDate);
    	pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.queryManpowerInputByMonth(pMap);
        return list;
    }
     ...
     */
    @Override
    public List<HumanInventoryDto> querySubprojectById(String customerId, String organId, String projectId, 
    		String type, String time) {
    	String year = DateUtil.getDBNow().substring(0, 4);
    	String befYear = (Integer.parseInt(year) - 1) + "";
    	String minDate = null, maxDate = null, befMinDate = null, befMaxDate = null;
    	if(!StringUtils.isEmpty(time)){
    		String[] times = time.split(",");
    		year = null;
    		befYear = null;
        	...
        	try {
        		befMinDate = sdf.format(getNewDateByMonth(sdf.parse(minDate), -12));
        		befMaxDate = sdf.format(getNewDateByMonth(sdf.parse(maxDate), -12));
        	} catch (Exception e) {
        		e.printStackTrace();
        		return null;
        	}
        ...
        if ("1".equals(type)) {
            ...
            paramParent.put("year", year);
            paramParent.put("minDate", minDate);
            paramParent.put("maxDate", maxDate);
            paramParent.put("befYear", befYear);
            paramParent.put("befMinDate", befMinDate);
            paramParent.put("befMaxDate", befMaxDate);
        ...
        param.put("befYear", befYear);
        param.put("befMinDate", befMinDate);
        param.put("befMaxDate", befMaxDate);
     ...
     */
    @Override
    public List<HumanInventoryInputTypeDto> queryFeeDetailById(String customerId, String organId, String projectId, 
    		String type, String time) {
        Map<String, Object> param = CollectionKit.newMap();
        Map<String, Object> paramParent = CollectionKit.newMap();
    ...
    public Map<String, Object> queryInputOutputByMonth(String customerId, String organId, String projectId,
        ...
        pMap.put("minDate", minDate);
        pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.queryInputOutputByMonth(pMap);
        HumanInventoryDto dto = humanInventoryDao.queryInputOutputByYear(pMap);
        map.put("list", list);
        map.put("dto", dto);
        return map;
    }
    ...
    public Map<String, Object> queryInputOutputAmount(String customerId, String organId, String year, String quarter) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.queryInputOutputAmount(customerId, subOrganIdList, year,
                quarter);
...
//    }
    ...
    public Map<String, Object> queryInputOutputMap(String customerId, String organId, String year) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.queryInputOutputMap(customerId, subOrganIdList, year);
        Map<String, Object> map = CollectionKit.newMap();
        Object[] redArrLast = new Object[list.size()];
        Object[] greArrLast = new Object[list.size()];
        int redNum = 0, greNum = 0;
        double maxNum = 0D;
    ...
    public Map<String, Object> queryProfitLossProject(String customerId, String organId, String year, String quarter) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        LinkedList<HumanInventoryChartDto> list = humanInventoryDao.queryProfitLossProject(customerId, subOrganIdList, year,
                quarter);
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        int more_con = 0;
        int less_con = 0;
    ...
    public Map<String, Object> getProfitAndLossCountAmount(String customerId, String organId, String year,
                                                           String month) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.getProfitAndLossCountAmount(customerId, subOrganIdList, year,
                month);
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        Double pNum = 0D;
        Double lNum = 0D;
    ...
    public Map<String, Object> getProfitAndLossProjectDetail(String customerId, String organId, String year,
                                                             String month) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.getProfitAndLossProjectDetail(customerId, subOrganIdList, year,
                month);
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        int pNum = 0, lNum = 0;
    ...
    public Map<String, Object> queryProjectManpower(String customerId, String organId, String year, String quarter) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.queryProjectManpower(customerId, subOrganIdList, year, quarter);
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        Double sum = 0d;
        int size = list.size() == 0 ? 0 : list.size();
    ...
    public Map<String, Object> queryProjectInputCost(String customerId, String organId, String year, String quarter) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.queryProjectInputCost(customerId, subOrganIdList, year, quarter);
        Map<String, Object> map = new LinkedHashMap<String, Object>();
        Double sum = 0D;
        int size = list.size() == 0 ? 0 : list.size();
        String[] sumDate = new String[size + 1];
    ...
    public Map<String, Object> queryProjectType(String customerId, String organId, String year) {
    	List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
        List<HumanInventoryChartDto> list = humanInventoryDao.queryProjectType(customerId, subOrganIdList, year);
    ...
    public List<Object> getDepartmentInput(String customerId, String organId, String projectId, String time) {
        ...
        pMap.put("minDate", minDate);
        pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.getDepartmentInput(pMap);
        List<Object> lastList = CollectionKit.newList();
        if(list != null && list.size() > 0){
        	if(list != null && list.size() > 0){
        		Map<String, Object> map = new LinkedHashMap<String, Object>();
    ...
    public List<Object> getJobSeqInput(String customerId, String organId, String projectId, String time) {
        ...
        pMap.put("minDate", minDate);
        pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.getJobSeqInput(pMap);
        List<Object> lastList = CollectionKit.newList();
        if(list != null && list.size() > 0){
        	if(list != null && list.size() > 0){
        		Map<String, Object> map = new LinkedHashMap<String, Object>();
    ...
    public List<Object> getRankInput(String customerId, String organId, String projectId, String time) {
        ...
        pMap.put("minDate", minDate);
        pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.getRankInput(pMap);
        List<Object> lastList = CollectionKit.newList();
        if(list != null && list.size() > 0){
        	Map<String, Object> map = new LinkedHashMap<String, Object>();
        	for (HumanInventoryDto dto : list) {
    ...
    public List<Object> getWorkplaceInput(String customerId, String organId, String projectId, String time) {
        ...
        pMap.put("minDate", minDate);
        pMap.put("maxDate", maxDate);
        List<HumanInventoryDto> list = humanInventoryDao.getWorkplaceInput(pMap);
        List<Object> lastList = CollectionKit.newList();
        if(list != null && list.size() > 0){
        	Map<String, Object> map = new LinkedHashMap<String, Object>();
        	for (HumanInventoryDto dto : list) {
...
//            }
     ...
     * 获取指定日期-年月
     */
    public static Date getNewDateByMonth(Date date, int month) {
    	Calendar c = Calendar.getInstance();
		c.setTime(date);
    	c.add(Calendar.MONTH, month);
    	return c.getTime();
     ...
     * */
	@Override
	public Map<String, Object> queryDates(String customerId, String organId) {
		String curDate = DateUtil.getDBNow().substring(0, 10);
		Map<String, Object> map = CollectionKit.newMap();
		List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
		String minDate = humanInventoryDao.queryDates(customerId, subOrganIdList);
		String[] arr = new String[4];
		arr[0] = curDate.substring(0, 4);
		arr[1] = "1";
		arr[2] = curDate.substring(0, 4);
		arr[3] = Integer.parseInt(curDate.substring(5, 7)) + "";
		map.put("minDate", minDate);
		map.put("maxDate", curDate);
		map.put("selectDate", arr);
		return map;
	}
	 ...
	 * */
	@Override
	public List<HumanInventoryChartDto> queryProfitByYear(String customerId, String organId, String date,
			String projectId) {
		List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
		String year = DateUtil.getDBNow().substring(0, 4);
		String minDate = null, maxDate = null;	
		if(!StringUtils.isEmpty(date)){
			...
			minDate = dates[0] + (Integer.parseInt(dates[1]) < 10 ? "0" + dates[1] : dates[1]);
			maxDate = dates[2] + (Integer.parseInt(dates[3]) < 10 ? "0" + dates[3] : dates[3]);
		}
		Map<String, Object> pMap = CollectionKit.newMap();
		pMap.put("customerId", customerId);
		pMap.put("year", year);
		...
		pMap.put("projectId", projectId);
		return humanInventoryDao.queryProfitByYear(pMap);
	}
	 ...
	 * */
	@Override
	public List<HumanInventoryChartDto> queryLeadingProjectInfo(String customerId, String organId) {
		String year = DateUtil.getDBNow().substring(0, 4);
		List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
		return humanInventoryDao.queryLeadingProjectInfo(customerId, subOrganIdList, year);
	}
	 ...
	 * */
	@Override
	public List<HumanInventoryChartDto> queryPartakeProjectInfo(String customerId, String organId) {
		String year = DateUtil.getDBNow().substring(0, 4);
		List<String> subOrganIdList = CacheHelper.getSubOrganIdList(organId);
		return humanInventoryDao.queryPartakeProjectInfo(customerId, subOrganIdList, year);
	}
}
