...
public interface HumanInventoryService {
	 ...
	 * @return
	 */
	public List<HumanInventoryDto> querySubprojectById(String customerId, String organId, String projectId, String type, String time);
	 ...
	 * @return
	 */
	public List<HumanInventoryInputTypeDto> queryFeeDetailById(String customerId, String organId, String projectId, String type, String time);
...
//			String detail, MultipartFile file);
	...
	public Map<String, Object> compareTemplateIsSame(String customerId, String organId, String tempType, String total, String detail,
     ...
     * 明细分析-本年利润
     * */
	public List<HumanInventoryChartDto> queryProfitByYear(String customerId, String organId, String date, String projectId);
