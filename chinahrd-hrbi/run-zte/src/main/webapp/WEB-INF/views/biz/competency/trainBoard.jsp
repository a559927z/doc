            ...
            <div class="row ct-row">
                ...
                <div class="col-sm-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        ...
                        <div class="index-common-title-text bottom-text">培训费用统计</div>
                    </div>
                    <div class="bottom-div">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span>(万元)</span><a href="javascript:void(0);" class="anchor" data-sign="0">更多培训费用统计&gt;</a></div>
                ...
                <div class="col-sm-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">人均培训费用统计</div>
                    </div>
                ...
                <div class="col-sm-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">培训计划完成率</div>
                    </div>
                    <div class="bottom-div">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span></span><a href="javascript:void(0);" class="anchor" data-sign="1">更多培训实施统计&gt;</a></div>
                ...
                <div class="col-sm-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">下级组织人均学时对比<span class="text-date" id="subOrganSchoolDate"></span></div>
                    </div>
                    <div class="bottom-div">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span>(小时)</span><a href="javascript:void(0);" class="anchor" data-sign="1">更多培训实施统计&gt;</a></div>
                ...
                <div class="col-sm-12 ct-line-col SetUpBody" >
                    ...
                    <div class="bottom-div bottom-div-three">
                        ...
                        <div class="table-body">
                            ...
                            <div class="col-md-12  col-xs-12" id="trainDeailTable" >
                                <label>&nbsp;</label>
...
<script type="text/javascript" src="${jsRoot}biz/competency/trainBoard.js"></script>
</body>
</html>
