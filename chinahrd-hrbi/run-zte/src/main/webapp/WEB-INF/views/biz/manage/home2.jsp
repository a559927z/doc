...
<div class="container-fluid ct-container-fluid ct-ancestors index">
    ...
    <div name="首页" class="row ct-row">
        ...
        <div name="团队提醒" showIndex="4" class="DRAG-DIV col-sm-6 ct-col">
            <div class="index-son-body">
                <div class="index-common-title">
                    ...
                    <div class="index-common-title-right">本月</div>
                </div>
                <div class="index-son-middle">
                    <div id="remindBody" class="col-xs-6 ct-col1 index-yj-div">
                        <div class="index-yj-div-top">
                            <div class="left">生日提醒</div>
                            <!--<div class="right">60%</div>-->
                        </div>
                        <div class="index-yj-float">
                    ...
                    <div class="col-xs-6 ct-col1 index-yj-div index-yj-div-tdtx">
                        <div class="index-yj-div-top">
                            <div class="left">入司周年提醒</div>
                            <div class="right birthdayBtnGroup" id="birthdayBtnGroup">
        ...
        <div class="DRAG-DIV col-sm-12 ct-col versionNumber">
        	<span>当前版本：v1.5（更新时间：2016-04-28）</span>
        </div>
	...
	<div class="modal fade popup-modal" id="versionModal" tabindex="-1" role="dialog"
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
                    <div class="modal-header-text" >v1.5更新内容：</div>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	            </div>
              <div class="modal-body">
                    <div class="row versionModalBody">
                        <div class="col-xs-12">
                            <span>1、</span> <span>新增“培训看板”指标；</span>
                        </div>
                       <div class="col-xs-12">
							<span>2、</span> <span>新增“薪酬看板”功能；</span>
                        </div>
						<div class="col-xs-12">
                            <span>3、</span> <span>优化“人才PK”指标UI界面；</span>
                        </div>
						<div class="col-xs-12">
                            <span>4、</span> <span>优化“团队画像”指标UI界面；</span>
                        </div>
						<div class="col-xs-12">
                            <span>5、</span> <span>优化“人力成本”指标UI界面；</span>
                        </div>
						<div class="col-xs-12">
                            <span>6、</span> <span>修复系统其他BUG；</span>
                        </div>
                    </div>
                </div>
	        </div><!-- /.modal-content -->
...
<script type="text/javascript" src="${ctx}/assets/js/biz/manageHome2.js"></script>
</body>
</html>