        ...
        <div class="row ct-row">
            <div class="col-sm-12 ct-line-col SetUpBody">
                ...
                <div class="bottom-div bottom-div-two">
                	<div id="dismissReasonSelect"></div>
                    <div class="row" id="dismissReason">
...
<script type="text/javascript" src="${jsRoot}biz/drivingforce/accordDismiss2.js"></script>
</body>
</html>
