                    ...
                    <div class="top-div">
                        ...
                        <div class="body-div" id="overtimeWarningDiv" style="cursor: pointer;">
                            ...
                            <div class="itembottom">
                                <span id="overtimeWarningPerson"></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ct-row">
                <div class="col-sm-6 ct-line-col SetUpBody" view="chart">
                    <div class="index-common-title bottom-title">
                        ...
                        <div class="index-common-title-text bottom-text">劳动力效能下级组织对比
                        <span class="text-date">操作提示：点击组织可查看下级组织的劳动力效能</span></div>
                    ...
                    <div class="bottom-div">
                        ...
                        <div class="chart-view">
                        	<div class="col-xs-12 bottom-div-first" style="margin-left: 230px;">
                        		<span id="returnParentOrgan" style="display: none; cursor: pointer;">返回上级</span>
                        	</div>
                            <div class="col-xs-12" id="laborRatioChart" ></div>
                        </div>
	                    <div class="table-view col-xs-12" id="laborRatioArea">
                ...
                <div class="col-sm-6 ct-line-col SetUpBody" view="chart">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">劳动力效能趋势
						<span class="text-date">操作提示：点击同比时间可查看组织下人员的劳动力效能</span></div>
                        <div class="rightSetUpBtn">
                ...
                <div class="col-sm-6 ct-line-col SetUpBody" view="chart">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">下级组织加班时长对比
                        <span class="text-date">操作提示：点击组织可查看下级组织的加班情况</span></div>
                        <div class="rightSetUpBtn">
                            <div class="rightSetUpBtnDiv rightSetUpLeft rightSetUpBtnSelect">
                                <div class="rightSetUpBtnTop"></div>
                    ...
                    <div class="bottom-div">
                        <div class="chart-view">
                            ...
                            <div class="col-xs-12 bottom-div-first" style="height: 30px;">单位：小时
                            	<span id="returnParentAvgOvertime" style="margin-left: 170px; display: none; cursor: pointer;">返回上级</span>
                            </div>
                        ...
                        <div class="table-view">
	                        ...
	                        <div class="col-xs-12 bottom-div-first" style="height: 30px;">单位：小时
	                        	<span id="returnParentTotalOvertime" style="margin-left: 170px; display: none; cursor: pointer;">返回上级</span>
	                        </div>
                ...
                <div class="col-sm-6 ct-line-col SetUpBody" view="chart">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">加班时长趋势
                        <span class="text-date">操作提示：点击时间可查看人员的加班时长趋势</span></div>
                        <div class="rightSetUpBtn">
                            <div class="rightSetUpBtnDiv rightSetUpLeft rightSetUpBtnSelect">
                                <div class="rightSetUpBtnTop"></div>
                                <div class="text">人均时长</div>
            	...
            	<div class="col-sm-12 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div">
                    	...
                    	<div class="col-sm-6">
                    		<div class="col-xs-12 right-title-first">
                    		...
                    		<div class="col-xs-12 right-title-second">
                    			<span>统计说明：“工时”统计单位为小时</span>
                    		</div>
                    		<div class="col-xs-12 content-tab">
                    			<table class="table">
									<thead>
                    ...
                    <div class="bottom-div-two">
                        <div class="col-sm-12 ct-line-col conditionBtnListBody" id="searchBox">
                            <div class="dis-search">
                                <input class="dis-search-input btn-margin" id="searchUserNameTxt" type="text" placeholder="输入员工姓名" style="float: left;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="condition-body" style="margin-left: 30px;">
					...
					<div class="condition-body-text left" style="margin-left: 35px;">时间范围：</div>
					...
					<div id="searchBtn" class="searchBtn" style="float: left; margin-left: 20px;">确定</div>
                </div>
                <p style="clear: left;"></p>
                <span class="text-date" style="margin-left: 30px;">统计说明：“实出勤”、“应出勤”统计单位为小时</span>
                <div class="tab-content">
                    <div id="tabpanel" role="tabpanel" class="col-xs-12 tab-pane active">
                        <div class="col-xs-12" id="laborEfficiencyTable">
                            ...
                            <table id="laborEfficiencySel"></table>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<div class="row tooltipModal" id="overtimeWarningPersonInfo">
    <div class="row base-info">
        ...
        <div class="col-xs-12">
        	加班时长&nbsp;&nbsp;&nbsp;&nbsp;
        	合计：<span id="overtimeCountHours">0</span>
        	小时
        </div>
    </div>
    <div class="row">
...
<script type="text/javascript" src="${jsRoot}biz/competency/laborEfficiency.js"></script>
</body>
</html>
