									...
									<div class="col-sm-12 col-xs-12">
										<div class="col-sm-7 col-xs-7">
									 	...
									 	<div class="col-sm-3 col-xs-3">
										 	<input type="text" name="sysname" required minlength="5" maxlength="30" class="form-control" id="XTSZ-sysName" placeholder="请输入系统名称"/>
										</div>
									</div>
								</div>
								<div class="split"></div>
								...
								<div class="form-group">
									<div class="col-sm-12 col-xs-12">
										<div class="col-sm-7 col-xs-7">
										 ...
										 <div class="explain">(admin是系统拥有的最高权限账户,请设置比较复杂的密码，以提高安全性。密码长度：10-20位)</div>
										</div>
									 	<div class="col-sm-3 col-xs-3">
										 	 <input type="password" name="password" class="form-control" id="XTSZ-adminPassword" placeholder="请输入admin密码"/>
										</div>
									</div>
								</div>
								<div class="split"></div>
								<div class="form-group">
									<div class="col-sm-12 col-xs-12">
										<div class="col-sm-7 col-xs-7">
									 	...
									 	<div class="col-sm-3 col-xs-3">
										 	 <input type="password" name="repassword"  class="form-control" id="again-XTSZ-adminPassword" placeholder="再一次输入admin密码"/>
										</div>
									</div>
								</div>
									</div>
										...
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="text" class="form-control" name="emailHost" id="XTSZ-eMailHost" placeholder="请输入邮箱主机"/>
												</div>
											</div>
										</div>
											<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="number" class="form-control" id="XTSZ-eMailPort" placeholder="请输入邮箱端口"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="email" class="form-control" id="XTSZ-eMailAccount" placeholder="请输入邮箱账户"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="text" class="form-control" id="XTSZ-eMailPassword" placeholder="请输入邮箱密码"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="email" class="form-control" id="XTSZ-adminMail" placeholder="请输入admin邮箱"/>
												</div>
											</div>
										</div>	
										<div class="split"></div>
										...
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="text" class="form-control" id="XTSZ-msgHost" placeholder="再一次输入admin密码"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="text" class="form-control" id="XTSZ-msgAccount" placeholder="请输入admin密码"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
										<div class="form-group">
											<div class="col-sm-12 col-xs-12">
												<div class="col-sm-7 col-xs-7">
											 	...
											 	<div class="col-sm-3 col-xs-3">
												 	 <input type="text" class="form-control" id="XTSZ-msgPassword" placeholder="请输入admin密码"/>
												</div>
											</div>
										</div>
										<div class="split"></div>
...
<script type="text/javascript" src="${ctx}/assets/js/biz/config.js"></script>
</body>
</html>
