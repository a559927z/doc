                            ...
                            <div class="content" id="budget">
                                ...
                                <div class="data hide">
                                    ...
                                    <div class="accord-bottom-float">
                                        ...
                                        <div class="accord-bottom-float-value accord-bottom-float-value">0%</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="top-div">
                        ...
                        <div class="body-div" id="salarystractureContent">
                            ...
                            <div class="data hide">
                                ...
                                <div class="text-center"><span id="salarystracture"></span>年</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="top-div">
                        ...
                        <div class="body-div" id="salaryrateContent">
                            ...
                            <div class="data hide">
                                ...
                                <div class="text-center"><span id="salaryrate"></span>年</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ct-row">
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span>&nbsp;</span></div>
                            <div class="col-xs-12 padding0 height350" id="salaryCostChart" ></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody" view="chart">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span>&nbsp;</span></div>
                            <div class="col-xs-12 padding0 height350" id="salaryCostSubTotalChart"></div>
                        </div>
                        <div class="table-view">
                            <div class="col-xs-12 bottom-div-first"><span></span></div>
                            <div class="col-xs-12 padding0 height350" id="salaryCostSubAvgChart"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span></span></div>
                            <div class="col-xs-12 padding0 height350" id="salarycompletionYearRateChart"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span></span></div>
                            <div class="col-xs-12 padding0 height350" id="salarycompletionMonthRateChart"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span></span></div>
                            <div class="col-xs-12 padding0 height350" id="salaryBringBackMonthChart"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span>&nbsp;</span></div>
                            <div class="col-xs-12 padding0 height350" id="salaryBringBackYearChart"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">薪酬差异度岗位表<span id="salaryDiffListDate"></span></div>
                    </div>
                    <div class="bottom-div clearfix">
                        <div class="chart-view" id="salaryDiff">
                            <table class="padding0" id="salaryDiffList"></table>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ct-line-col SetUpBody">
                    <div class="index-common-title bottom-title">
                        <div class="index-common-title-left bottom-left"></div>
                        <div class="index-common-title-text bottom-text">员工CR值<span id="salaryCrChartDate"></span></div>
                    </div>
                    <div class="bottom-div clearfix">
                        <div class="chart-view">
                            <div class="col-xs-12 bottom-div-first"><span></span><a id="salaryCrMore" href="javascript:;">更多员工CR值&gt;</a></div>
                            <div class="col-xs-12 padding0 height320" id="salaryCrChart"></div>
                            <div class="marginleft15">注：此图只显示最新一期绩效为五星的人员</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bottom-div bottom-div-two">
                        <div>
                            <div class="col-md-6 col-xs-12 padding0">
                                <div class="col-xs-12 bottom-div-first marginleft15">职位序列固浮比统计<span id="positionChartDate"></span></div>
                        ...
                        <div class="marginleft15">操作提示：点击职位序列可查看该序列下的职级分布，再次点击则可返回默认统计</div>
                    </div>
                    ...
                    <div class="bottom-div bottom-div-two clearfix bordertop0">
                        <div>
                            <div class="col-md-6 col-xs-12 padding0">
                                ...
                                <div class="col-xs-12 padding0 height350" id="subOrgChart"></div>
                            </div>
                            <div class="col-md-6 col-xs-12 padding0" style="border-left: none;">
                                <div class="col-xs-12 bottom-div-first">&nbsp;</div>
                ...
                <div class="col-sm-12 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div bottom-div-two clearfix">
                        <div class="col-md-5 col-xs-12 ct-col1">
                            <div class="col-xs-12 bottom-div-first">国家固定福利（五险一金）</div>
                    ...
                    <div class="bottom-div bottom-div-two clearfix bordertop0">
                        <div class="col-md-5 col-xs-12 ct-col1">
                            <div class="col-xs-12 bottom-div-first">企业福利（货币）</div>
                    ...
                    <div class="bottom-div bottom-div-two clearfix bordertop0">
                        <div class="col-md-5 col-xs-12 ct-col1">
                            <div class="col-xs-12 bottom-div-first">企业福利（非货币）</div>
        ...
        <div id="page-four" class="rightBodyPage">
            <div class="row ct-row">
                <div class="col-sm-12 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div bottom-div-two clearfix borderbottom0 borderright0">
                        <div class="">
                            <div class="col-md-6 col-xs-12 borderleft0 borderbottom1 borderright1">
                                <div class="col-xs-12 bottom-div-first paddingleft0">持股员工总数年度趋势</div>
                                <div class="col-xs-12 bottom-div-second">(人)</div>
                                <div class="col-xs-12" id="shareTotalYearChart"></div>
                            </div>
                            <div class="col-md-6 col-xs-12 borderleft0 borderbottom1 borderright1">
                                <div class="col-xs-12 bottom-div-first paddingleft0">持股数量年度趋势</div>
                                <div class="col-xs-12 bottom-div-second">(万股)</div>
                                <div class="col-xs-12" id="shareTendencyYearChart"></div>
                            </div>
                            <div class="col-md-6 col-xs-12 borderleft0 borderbottom1 borderright1">
                                <div class="col-xs-12 bottom-div-first paddingleft0">下级组织持股员工数</div>
                                <div class="col-xs-12 bottom-div-second">(人)</div>
                                <div class="col-xs-12" id="shareStaffTotalChart"></div>
                            </div>
                            <div class="col-md-6 col-xs-12 borderleft0 borderbottom1 borderright1">
                                <div class="col-xs-12 bottom-div-first paddingleft0">下级组织持股数量</div>
                                <div class="col-xs-12 bottom-div-second">(万股)</div>
                                <div class="col-xs-12" id="shareSubOrgTotalChart"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 ct-line-col SetUpBody">
                    ...
                    <div class="bottom-div bottom-div-four">
                        ...
                        <div class="table-body">
                            ...
                            <div class="col-md-12  col-xs-12" id="sharesDeailTable" >
                                <label>&nbsp;</label>
                                <table class="borderless" id="sharesDetailGrid" style="max-height: 400px;overflow-y:auto;"></table>
...
<!-- 员工CR值 -->
<div class="modal fade" id="moreCr" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body page-content" id="crMoreGrid">
                <div id="moreCrGrid" style="padding:15px;">
...
<script type="text/javascript" src="${jsRoot}biz/drivingforce/salaryBoard.js"></script>
</body>
</html>
