...
<div class="row ct-row">
    ...
    <div class="col-sm-2 ct-18 ct-line-col">
        <div class="top-div showview" id="tooltip1" data-toggle="tooltip" data-placement="bottom">
            ...
            <div class="index-yj-div-bottom size-12">
                <div class="index-yj-div-bottom-value left" id="userNames1">无</div>
    ...
    <div class="col-sm-2 ct-18 ct-line-col">
        <div class="top-div showview" id="tooltip2" data-toggle="tooltip" data-placement="bottom">
            ...
            <div class="index-yj-div-bottom size-12" >
                <div class="index-yj-div-bottom-value left" id="userNames2">无</div>
                <div class="index-yj-div-bottom-right right"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 ct-18 ct-line-col">
        <div class="top-div showview" id="tooltip3" data-toggle="tooltip" data-placement="bottom">
            ...
            <div class="index-yj-div-bottom size-12">
                <div class="index-yj-div-bottom-value left" id="userNames3">无</div>
                <div class="index-yj-div-bottom-right right"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 ct-18 ct-line-col">
        <div class="top-div showview" id="tooltip4" data-toggle="tooltip" data-placement="bottom">
            ...
            <div class="index-yj-div-bottom size-12">
                <div class="index-yj-div-bottom-value left" id="userNames4">无</div>
                <div class="index-yj-div-bottom-right right"></div>
            </div>
        </div>
    </div>
                ...
                <div class="row ct-row">
                    <div class="col-xs-12 BSetUp-col">
                        <div class="BSetUp-line-two BSetUp-line-three">
                            <span class="CSetUp-text-one left">绩效周期：</span>
                            <select class="CSetUp-select left" id="perfmanWeekObj">
                                <option value="1">一年</option>
                                <option value="2">半年</option>
                                <option value="3">季度</option>
                            </select>
                            <div class="CSetUp-text-two left">说明：设置企业绩效评估周期</div>
                        </div>
                    </div>
                    <div class="col-xs-12 BSetUp-col">
                        <div class="BSetUp-line-two BSetUp-line-three">
                            <span class="CSetUp-text-one left">高绩效定义为：</span>
                            <input type="number" id="minHeightPerObj" class="condition-input-text left">
                            <span class="condition-text-one left">-</span>
                            <input type="number" id="maxHeightPerObj" class="condition-input-text condition-input-text-too left">
                            <div class="CSetUp-text-two left">说明：定义企业高绩效范围</div>
                        </div>
                    </div>
                    <div class="col-xs-12 BSetUp-col">
                        <div class="BSetUp-line-two">
                            <span class="CSetUp-text-one left">低绩效定义为：</span>
                            <input type="number" id="minLowPerObj" class="condition-input-text left">
                            <span class="condition-text-one left">-</span>
                            <input type="number" id="maxLowPerObj"class="condition-input-text condition-input-text-too left">
                            <div class="CSetUp-text-two left">说明：定义企业低绩效范围</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${ctx}/assets/js/biz/productivity/perChange2.js"></script>
</body>
</html>