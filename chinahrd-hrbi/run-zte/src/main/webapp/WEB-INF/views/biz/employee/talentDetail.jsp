...
<body>
					...
					<div class="row">
						<div class="col-sm-2 col-xs-12">
							<div class="talent-detail-photo">
								<img src="${empDto.imgPath}" onerror="this.src='${ctx}/assets/img/base/u-default.png'" alt="${empDto.userName}" class="img-circle" />
							</div>
							<input type="hidden" id="empId" value="${empDto.empId}">
						</div>
						<div class="col-sm-5 col-xs-12">
							<div class="col-xs-12"><label>${empDto.userName}</label></div>
							<div class="col-xs-12"><label>任职部门</label><span>${empDto.organName}</span></div>
							<div class="col-xs-12"><label>任职岗位</label><span>${empDto.positionName}</span></div>
							<div class="col-xs-12"><label>工作地点</label><span>${empDto.workPlace}</span></div>
						...
						<div class="col-sm-5 col-xs-12">
							...
							<div class="col-xs-12"><label>入职时间</label><span><fmt:formatDate value="${empDto.entryDate}" pattern="yyyy-MM-dd" /></span></div>
		...
		<div class="row column panel-main-header" id="myScrollspy">
			<div class="col-xs-2" id="myNav_div">
				<ul class="nav u-affix-nav" id="myNav">
					...
					<li><a href="#section-2">任职信息</a></li>
					<li><a href="#section-3">绩效信息</a></li>
					<li><a href="#section-4">能力信息</a></li>
					<li><a href="#section-5">奖惩信息</a></li>
					<li><a href="#section-6">培训经历</a></li>
					<li><a href="#section-7">过往履历</a></li>
					<li><a href="#section-8">教育背景</a></li>
					<li><a href="#section-9">所获职称</a></li>
					<li><a href="#section-10">家庭关系</a></li>
					<li><a href="#section-11">其它技能/特长</a></li>
				</ul>
			</div>
			<div class="col-xs-10">
				...
				<div class="panel panel-default">
					...
					<div class="panel-collapse collapse in" id="collapseTwo">
						<div class="panel-body page-main-header">
							...
							<div class="row">
								<div class="col-xs-12"><span class="page-main-title">工作异动</span></div>
								<div class="col-xs-12" id="jobChangeTable">
									<table class="borderless" id="jobChangeGrid"></table>
								</div>
							</div>
							<div class="row" id="growUpDiv">
								<div class="col-xs-12"><span class="page-main-title">成长轨迹</span></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-collapse collapse in" id="collapseThree">
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-xs-12"><span class="page-main-title">绩效轨迹</span></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-collapse collapse in" id="collapseFour">
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-12"><span class="page-main-title col-row-mt0">360领导力测评报告</span></div>
								<div class="col-xs-12" id="evaluationTable">
									<table class="borderless" id="evaluationGrid"></table>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12"><span class="page-main-title">其它测评报告</span></div>
	...
	<script type="text/javascript" src="${jsRoot}biz/employee/talentDetail.js"></script>
</body>
</html>