...
<link rel="stylesheet"
	href="${ctx}/assets/css/datetime/datetimepicker.css" />
<link rel="stylesheet"
	href="${ctx}/assets/css/biz/competency/talentProfitLoss.css" />
<link rel="stylesheet" href="${ctx}/assets/css/zTreeStyle/metro.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets/css/biz/competency/talentProfitLoss_pieGrid.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets/css/global.css" />
</head>
<body>
			...
			<div class="row ct-row">
				...
				<div class="col-sm-3 ct-22 ct-line-col">
					<div class="top-div">
						...
						<div class="body-div style-pointer" id="outflowCountDetail">
							<div class="accord-yj-float">
								<span class="accord-yj-float-value" id="outflowCountNum">0</span>
								<span class="accord-yj-float-people">人</span>
							</div>
							<div class="itembottom">
								<span id="outflowPersonText"></span>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bottom-div">
						<div class="chart-view">
							<div class="col-xs-12 bottom-div-first">
								...
								<span class="bottom-div-text left">损益值</span>
								<label></label>
								<div class="chart-legend">
									<div class="old-legend left"></div>
									<div class="left text" id="oldLegend"></div>
									<div class="cur-legend left"></div>
					...
					<div class="bottom-div-change">
						<div class="table-view">
							<div class="col-xs-12 bottom-div-count">
								<div class="count-title-first" style="float: left;">统计时间：</div>
									<div class="title-float date-input">
										<div class="input-group date startDate">
											<input type="text" class="form-control form_datetime"
												readonly="readonly" value="${startDate}"> <span class="input-group-addon"><span
							...
							<div class="col-xs-12 bodyRowHeight" id="positionSequenceChart">
								<div class="grid" >
									<input type="hidden" id="initFormatDate" value="${date}" /> <input
										type="hidden" id="initDate" value="${date}" /> <input
										type="hidden" id="mainSeqId"
										value="${fn:escapeXml(mainSeqId)}" /><input type="hidden"
										id="parentType" value="p0" /><input type="hidden"
										id="childType" value="" /><input type="hidden" id="uniqueId"
										value="" /> <input type="hidden" id="deptName" value="" />
									<div class="row column">
										<div class=" col-sm-12 col-xs-24">
											...
											<!-- left -->
											<!-- right -->
											<div class="span17 detailseq_area">
												...
												<div class="seqdetail">
													...
													<div class="childseq_con" id="subSeq">
														<div class="span24">
															...
															<div id="entryDiv" class="child-right-grid">
					...
					<div class="modal-body">
						<ul class="nav nav-tabs f-white-bg" role="tablist"
							...
							<li role="presentation" class="active"><a href="#inflowTab"
								aria-controls="inflowTab" role="tab" data-toggle="tab">流入&nbsp;<span
	...
	<script type="text/javascript"
		src="${jsRoot}lib/plugins/echarts/echarts.js"></script>
	<script type="text/javascript"
		src="${jsRoot}lib/plugins/echarts/echarts-plain-original-map.js"
		charset="utf-8"></script>
	<script type="text/javascript"
		src="${jsRoot}biz/competency/talentProfitLoss_pieGrid.js"
		charset="utf-8"></script>
	<script type="text/javascript"
		src="${jsRoot}biz/competency/talentProfitLoss.js"></script>
</body>
</html>
