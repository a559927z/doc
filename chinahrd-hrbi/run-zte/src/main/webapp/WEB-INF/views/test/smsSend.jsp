...
<head>
	...
	<script src="${ctx}/assets/js/lib/jquery/jquery-1.7.2.js" type="text/javascript"></script>
	<script src="${ctx}/assets/js/lib/jquery-validation/1.11.1/jquery.validate.min.js" type="text/javascript"></script>
	<script src="${ctx}/assets/js/lib/jquery-validation/1.11.1/messages_bs_zh.js" type="text/javascript"></script>
	<link href="${ctx}/assets/js/lib/jquery-validation/1.11.1/validate.css" type="text/css" rel="stylesheet" />
</head>
