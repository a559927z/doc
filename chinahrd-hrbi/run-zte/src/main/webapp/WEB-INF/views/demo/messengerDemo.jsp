...
<head>
	...
	<title>提示控件</title>
	<!-- 这两个css文件是必须的，已加入公共模块中，故不用在页面jsp加了 -->
	<link href="${ctx}/assets/css/messenger/messenger.css" rel="stylesheet" />
	<link href="${ctx}/assets/css/messenger/messenger-theme-future.css" rel="stylesheet" />
<style>
</style>
</head>
<body>
