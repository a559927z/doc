...
<%-- <link rel="stylesheet" href="${webRoot}/static/css/widget.css" type="text/css"></link> --%>
<link rel="stylesheet" type="text/css" href="${ctx}/assets/css/zTreeStyle/zTreeStyle.css"/>
<link href="${ctx}/assets/css/zTreeStyle/metro.css" rel="stylesheet" />

<link rel="stylesheet" type="text/css" href="${ctx}/assets/css/job_main_seq_count2.css" />
...
<%-- 					<input type="hidden" id="deptName" value="${deptName}"/> --%>
		...
		<div class="row column">
			...
			<!-- right -->
				<div class="span17 detailseq_area" style="display:none;">
					<span style="float:right;margin-top:10px;margin-right:10px;"><a class="seqdetailclose" id="titleLvClose" href="javascript:void(0);"></a></span>
					<div class="seqdetail">
	...
	<script type="text/javascript" src="${jsRoot}lib/plugins/echarts/echarts-plain-original-map.js" charset="utf-8"></script>
	<script type="text/javascript" src="${jsRoot}demo/job_main_seq_count2.js" charset="utf-8"></script>
</body>
</html>