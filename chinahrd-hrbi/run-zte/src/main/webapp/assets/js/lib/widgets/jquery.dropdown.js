...
define(["jquery-ui"], function(require) {
	...
	$.widget("W.jQdropdown", {
		...
		_addBtnbox : function(dropdown) {
            ...
            //更改
            var input = $("<div class='dropdown-obj' type='text' readonly='true'><span class='dropDownValue dropdown-obj'></span><div class='dropDownRightBtn dropdown-obj'><div class='dropDownBlackIcon dropdown-obj'></div></div></div>").on("mouseenter",function() {
                self.show(1);
                $(".u-dropdown-input").css("backgroundColor","#62a8d1");
...
//                var e = arguments.callee.caller.arguments[0] || window.event;
                if($(e.toElement).hasClass("dropdown-obj") || $(e.toElement).hasClass("ct-u-dropdown-arrow")){
                    ...
                    self.hide(1);
                    $(".u-dropdown-input").css("backgroundColor","#438eb9");
                }
...
//                }
		...
		_checkableWidget : function() {
			...
			/*	opt.autoHide &&	this._dropdown.on("mouseleave", function() {
				...
				//var tid = 0;
				if(opt.autoHide) {
                    //改动 郑宇明 2016-1-28 点击出现_dropdown修改为鼠标移动上去就出现 begin
