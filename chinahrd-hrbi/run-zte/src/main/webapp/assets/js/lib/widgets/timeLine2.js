 ...
 */
define(['template', 'moment', 'jquery-mCustomScrollBar'], function (tpl, moment) {
    ...
    var template = '<div class="index-common-title">'
        ...
        + '</div>'
        + '<!--备忘录 弹出框 begin-->'
        + '<div class="ct-drag memo-window">'
        + ' <div class="drag-body">'
        + '     <div class="drag-content">'
        + '         <div class="drag-title">'
        + '             <div class="drag-title-blue"></div>'
        + '             <div class="drag-title-text">备忘录</div>'
        ...
        + '             </div>'
        + '         </div>'
        + '         <div class="drag-bottom memo-bottom">'
                ...
                $.post(Urls.deleteMemoUrl, {
                    ...
                    if (rs.type) {
                        if($(".shade").css('display') == 'none'){
                            extendDateToHtml(_e, rs.t, options);
                            $(".shade").hide();
                            return true;
                        }
