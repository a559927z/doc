...
require(['bootstrap', 'jgGrid', 'underscore','messenger'], function () {
    ...
    var gridOption = {
        ...
        colModel: [
            ...
            {name: 'userNameCh', index: 'userNameCh', editable: true, sortable: false,width: 80, editoptions: {size: "20", maxlength: "30"}},
            {name: 'organizationName', index: 'organizationName', sortable: false,width: 100, editable: true, editoptions: {size: "20", maxlength: "30"}},
            {name: 'positionName', index: 'positionName', width: 80, sortable: false,editable: true, align: 'center', editoptions: {size: "20", maxlength: "5"}},
            {name: 'sequenceName', index: 'sequenceName', width: 80,sortable: false, editable: true, align: 'center', editoptions: {size: "20", maxlength: "30"}},
            {name: 'abilityName', index: 'abilityName', width: 80,sortable: false, editable: true, align: 'center', editoptions: {size: "20", maxlength: "30"}},
            {
                name: 'myac', index: '', width: 200, fixed: true, align: 'center', sortable: false, resize: false, search: false
            }
        ],
        hideCol: ['userKey'],
        rownumbers: true,
