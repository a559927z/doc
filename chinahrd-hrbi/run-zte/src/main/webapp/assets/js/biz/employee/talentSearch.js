...
require(['bootstrap', 'jgGrid', 'underscore'], function () {
    ...
    var gridOption = {
        ...
        colModel: [
            ...
            {name: 'userNameCh', index: 'userNameCh', editable: true, width: 80, sortable: false,editoptions: {size: "20", maxlength: "30"}},
            {name: 'organizationName', index: 'organizationName', width: 90, sortable: false,editable: true, editoptions: {size: "20", maxlength: "30"}},
            {name: 'positionName', index: 'positionName', width: 90,sortable: false, editable: true, align: 'center', editoptions: {size: "20", maxlength: "5"}},
            ...
            {
                name: 'myac', index: '', width: 220, fixed: true, align: 'center', sortable: false, resize: false, search: false
            }
        ],
        hideCol: ['userKey'],
        rownumbers: true,
