...
//                });
    ...
    var preDistributionObj = {
        ...
        getStarChartData: function (organizationId, yearMonth, empType) {
            ...
            var self = this;
            $.get(urls.queryPreStarCountByMonth, {organizationId: organizationId, yearMonth: yearMonth}, function (data) {
                    if (!$.isEmptyObject(data)) {
            ...
            $.ajax({
                ...
                success: function (data) {
                     ...
                     if(self.recordTotal[self.organizationId+self.yearMonth]){
                         self.recordTotal[self.organizationId+self.yearMonth][empType]={total:orgEmpCount,joinCount:self.joinEmpCount};
                      }else{
            ...
            if(query){
            	 $.ajax({
                     ...
                     success: function (data) {
                         ...
                         self.recordTotal[self.organizationId+self.yearMonth][type]={total:orgEmpCount,joinCount:joinCount}; 
                     }
                 });
            }else{
...
//            $('#performanceDetailGrid').jqGrid('setGridHeight',tbBodyHeigth);
    ...
    function initAll(id) {
        reqOrgId = id;
//		reqOrgId='15e24f67bddd47ee94a9a09e7ff1d2b8';
        initArrYearMonths();
        initOrganTree();	//机构树
