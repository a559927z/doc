require(['jquery', 'moment', 'echarts', 'echarts/chart/funnel', 'echarts/chart/line', 'echarts/chart/bar', 'echarts/chart/pie', 'bootstrap', 'underscore',
    ...
    var teamImgAbObj = {
        ...
        initData: function (organId) {
            ...
            var sexPerV = _.isUndefined(sexPerData.v) ? '' : sexPerData.v;
            ...
            var yearsV = _.isUndefined(yearsData.v) ? '' : yearsData.v;
            if (!_.isEmpty(yearsV)) {
                $('#teamImgYear').show();
            ...
            var marryV = _.isUndefined(marryData.v) ? '' : marryData.v;
            if (!_.isEmpty(marryV)) {
                $('#teamImgMarry').show();
