package net.chinahrd.laborEfficiency.mvc.pc.service;
...
public interface LaborEfficiencyService {
	 ...
	 * 月考勤报表导出
	 */
	void attendanceMonthly(HttpServletResponse response, String yearmonth, String coustomerId, String orgId);
