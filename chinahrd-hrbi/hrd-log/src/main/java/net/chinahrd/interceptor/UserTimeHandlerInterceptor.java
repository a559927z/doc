...
public class UserTimeHandlerInterceptor extends HandlerInterceptorAdapter {
        ...
        try {
            if (handler instanceof HandlerMethod) {
                ...
                AopInformation aopInfo =
                        packDto(beginTime, endTime, beanName, methodName, uri, remoteAddr, method, sbf, useTime, empInfo);
                logMgrService.information(aopInfo);
            }
        } catch (Exception e) {
            //出错
    ...
    private AopInformation packDto(
        ...
        aopInfo.setUserId(empInfo.getUserId());
