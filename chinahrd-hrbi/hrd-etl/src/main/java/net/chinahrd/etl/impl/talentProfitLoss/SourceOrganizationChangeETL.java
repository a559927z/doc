package net.chinahrd.etl.impl.talentProfitLoss;
...
public class SourceOrganizationChangeETL extends SimpleAbstractEtl<SourceOrganizationChangeEntity> implements Runnable {
