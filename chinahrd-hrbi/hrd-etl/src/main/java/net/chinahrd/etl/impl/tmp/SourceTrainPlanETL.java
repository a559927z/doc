...
import net.chinahrd.etl.entity.SourceTrainPlanEntity;
import net.chinahrd.etl.sql.SqlAuxiliary;

public class SourceTrainPlanETL extends SimpleAbstractEtl<SourceTrainPlanEntity> {
	...
	protected SqlAuxiliary getSqlAuxiliary() {
		return SourceTrainPlanEntity.getEntityAuxiliary()
