...
-- ----------------------------------------------------
-- 2月份考勤中对应的3天，01~02, 11日(正常出勤 --> 年假)
-- ----------------------------------------------------
call pro_update_emp_attendance('1','焦春学','正常出勤','年假','2019-02-01','2019-02-02', -2.0);
call pro_update_emp_attendance('1','焦春学','正常出勤','年假','2019-02-11','2019-02-11', -1.0);
