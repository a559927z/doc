...
-- ----------------------------------------------------
call pro_update_emp_attendance('1','单考','正常出勤','年假','2018-11-29','2018-11-30', -2.0);

SELECT * from emp_vacation where emp_id = (SELECT emp_id FROM dim_user t WHERE t.user_name_ch = '单考');
