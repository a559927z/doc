package net.chinahrd.zte.talentProfitLoss.mvc.pc.controller;
...
import net.chinahrd.zte.talentProfitLoss.mvc.pc.service.TalentProfitLossService;
...
public class TalentProfitLossController extends BaseController {
	...
	public Map<String, Object> queryTalentInflowVal(String organId) {
		...
		String year = DateUtil.getDBNow().substring(0, 4);
		String month = DateUtil.getDBNow().substring(5, 7);
		Map<String, Object> map = talentProfitLossService.queryTalentInflowVal(getCustomerId(), organId, year, month,
				list);
		return map;
	}
	...
	public Map<String, Object> queryTalentOutflowVal(String organId) {
		...
		String year = DateUtil.getDBNow().substring(0, 4);
		String month = DateUtil.getDBNow().substring(5, 7);
		Map<String, Object> map = talentProfitLossService.queryTalentOutflowVal(getCustomerId(), organId, year, month,
				list);
		return map;
	}
	...
	public List<Object> queryPopulationPie(String organId, String provinceName, String times, String crowds) {
		if (StringUtils.isEmpty(organId)) {
			return null;
		}
		String[] t = null;
		...
		return talentProfitLossService.queryPopulationPie(getCustomerId(), organId, provinceName, t, c);
	}
	...
	public void queryInflowOutflowChangeType(HttpServletResponse response, String organId, String startDate,
		...
		try {
			...
			Map<String, Object> map = talentProfitLossService.queryInflowOutflowChangeType(getCustomerId(), organId,
					startDate, endDate, parentList, childType, inflowList, outflowList, fullList);
	...
	public Map<String, Object> querySequenceBar(String organId, String startDate, String endDate, String parentType,
		...
		return talentProfitLossService.querySequenceBar(getCustomerId(), organId, startDate, endDate, parentList,
				childType, changeType, inflowList, outflowList, fullList);
	}
	...
	public Map<String, Object> queryAbilityBar(String organId, String startDate, String endDate, String parentType,
		...
		return talentProfitLossService.queryAbilityBar(getCustomerId(), organId, startDate, endDate, parentList,
				childType, changeType, inflowList, outflowList, fullList);
	}
	...
	public PaginationDto<TalentProfitLossDto> queryEntryListDatas(String organId, String startDate, String endDate,
		...
		return talentProfitLossService.queryEntryListDatas(getCustomerId(), organId, startDate, endDate, parentList,
				childType, changeType, page, rows, inflowList, outflowList, fullList);
	}
}
