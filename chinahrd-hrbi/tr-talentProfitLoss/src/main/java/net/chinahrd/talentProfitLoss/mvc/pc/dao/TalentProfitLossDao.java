package net.chinahrd.talentProfitLoss.mvc.pc.dao;
...
public interface TalentProfitLossDao {
	...
	public List<TalentProfitLossDto> queryTalentInflowVal(@Param("customerId") String customerId,
			@Param("organId") String organId, @Param("befYearMonth") String befYearMonth, @Param("endYearMonth") String endYearMonth,
	 ...
	 * 异动统计饼图表格-job_change
	 */
	public Integer queryInflowOutflowChangeTypeCountByJc(Map<String, Object> map);
	 ...
	 * 异动统计饼图表格-job_change
	 */
	public List<TalentProfitLossDto> queryInflowOutflowChangeTypeByJc(Map<String, Object> map);
	 ...
	 */
	public Integer querySequenceBarCountByJc(Map<String, Object> map);
	
	/**
	 * 异动统计-序列分布-job_change
	 */
	public List<TalentProfitLossDto> querySequenceBarByJc(Map<String, Object> map);
	 ...
	 */
	public Integer queryAbilityBarCountByJc(Map<String, Object> map);
	
	/**
	 * 异动统计-职级分布-job_change
	 */
	public List<TalentProfitLossDto> queryAbilityBarByJc(Map<String, Object> map);
	
	/**
	 * 异动统计-入职名单-job_change
	 */
	public Integer queryEntryListDatasCountByJc(Map<String, Object> map);
	
	/**
	 * 异动统计-入职名单-job_change
	 */
	public List<TalentProfitLossDto> queryEntryListDatasByJc(Map<String, Object> map);
}