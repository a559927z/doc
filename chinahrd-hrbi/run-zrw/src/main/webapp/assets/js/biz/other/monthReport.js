require(['jquery', 'jquery-ui', 'echarts', 'echarts/chart/bar', 'echarts/chart/line', 'echarts/chart/pie', 'echarts/chart/gauge',
    ...
    var pageSettingObj = {
        ...
        initFisrtSetting: function () {
            ...
            //菜单点击事件
            $menuBlock.children(".menu-line").click(function (e) {
                e.stopPropagation();
            ...
            //第一次弹出框选中事件
            $fisrtBlock.children('.setting-page').click(function () {
                $(this).toggleClass('selected');
            });

            //第一次弹出框确认事件
            $fisrtBlock.find('.success-btn').click(function () {
    ...
    $('#pagePanels').find('.index-jxmb-btn').click(function () {
        var $this = $(this);
    ...
    var talentStructureObj = {
        ...
        renderChart: function () {
            ...
            budgetOption.series[0].data[0].value = data.value;
            ...
            self.chartObj.clear();
            self.chartObj.setOption(budgetOption, true);
...
//			canvas.style.cssText += canvasStyle;
    ...
    var salesCountObj = {
        ...
        init: function (organId) {
            ...
            if (_.isNull(self.salesByOrganGridObj)) {
                ...
                productOption.colNames = ['', '组织机构', '销量', '人均销量', '目标值（万元）', '销售额（万元）', '回款额（万元）', '达标率', '回款率'];
        ...
        initItemSelector: function (type, data) {
            ...
            $.each(data, function (idx, obj) {
                ...
                html += '<input type="radio" class="salesRadio" value="' + obj.k + '">' + obj.v;
                html += '</label>';
                $targetObj.append(html);
            });
            $targetObj.children().unbind('click').click(function () {
                var $this = $(this);
                var itemId = $this.children('.salesRadio').val();
            ...
            $.each(yearMonths, function (idx, v) {
                ...
                $.each(obj, function (i, o) {
                    html += '    <li><i class="zrw-circle"></i>' + o.fileName
                        + '<span class="li-remove" data-remove="' + o.savaId + '">取消收藏</span><span class="li-link" data-link="'
                        + o.path + '">查看</span></li>';
                });
                html += '</ul>';
                html += '</div>';
    ...
    var pageThreeObj = {
        ...
        requestData: function () {
            ...
            $.get(urls.getEmpShareUrl, function (rs) {
                if (_.isEmpty(rs)) {
        ...
        render: function (data) {
            ...
            $.each(yearMonths, function (idx, v) {
                ...
                html += '<ul class="list-unstyled spaced3">';
                $.each(obj, function (i, o) {
                    html += '    <li><i class="zrw-circle"></i>' + o.fileName + '<span class="li-link" data-link="' + o.path + '">查看</span></li>';
                });
                html += '</ul>';
                html += '</div>';
                html += '</div>';
    ...
    $('#shareSendingBtn').click(function () {
