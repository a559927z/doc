...
<div class="index">
    ...
    <div name="首页" class="row ct-row">
        ...
        <div class="DRAG-DIV col-sm-12 ct-col versionNumber">
        	<span>当前版本：v1.7（更新时间：2016-09-29）</span>
        </div>
	...
	<div class="modal fade popup-modal" id="versionModal" tabindex="-1" role="dialog"
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
                    <div class="modal-header-text" >v1.7更新内容：</div>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	            </div>
              <div class="modal-body">
                    <div class="row versionModalBody">
                        <div class="col-xs-12">
                            <span>1、</span> <span>新增“招聘看板”指标 ;</span>
                        </div>
                       <div class="col-xs-12">
							<span>2、</span> <span>新增“人才损益”指标 ;</span>
                        </div>
						<div class="col-xs-12">
                            <span>3、</span> <span>新增“劳动力效能”指标 ;</span>
                        </div>
						<div class="col-xs-12">
                            <span>4、</span> <span>修复系统其他BUG；</span>
                        </div>
                    </div>
                </div>
	        </div><!-- /.modal-content -->
