...
<div class="promote-board" id="promoteboard">
    ...
    <div class="rightBody rightBody10">
        <div id="page-one" class="rightBodyPage">
            ...
            <div id="applicationSomeConformityNum" class="col-sm-3 ct-22 ct-line-col">
                <div class="top-div">
                    <div class="index-common-title">
                        <div class="index-common-title-left"></div>
                        <div class="index-common-title-text">部分符合条件<i class="icon-question-sign"></i></div>
                    </div>
                    <div class="body-div">
                        <div class="data loadingtext">数据加载中</div>
                        <div class="data hide">
            ...
            <div class="col-sm-12 ct-line-col SetUpBody">
                ...
                <div class="bottom-div bottom-div-two borderbottom0 borderright0">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 promoteSpeed">
                            <div>趋势分析</div>
                            <div class="paddingbottom0">
                                <div id="promoteTrendSelect"></div>
                        ...
                        <div class="col-md-6 col-sm-12 promoteSpeed">
                            ...
                            <a class="hide" id="returnOrgan">
                                <label class="hide returnOrganText">返回上级</label>
                                <!-- <label class="hide returnTeamText">返回团队</label> -->
                            </a>
                            </div>
                            <div class="paddingbottom0">
                                <div id="promoteSubOrgSelect"></div>
                        ...
                        <div class="col-md-6 col-sm-12 promoteSpeed">
                            <div>序列统计</div>
                            <div class="paddingbottom0">
                                <div id="promoteSequenceSelect"></div>
                ...
                <div class="bottom-div bottom-div-two borderbottom0">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 promoteTrack">
                            ...
                            <div class="ptbody" id="promoteTrackChart"></div>
                        </div>
                        <div class="col-md-6 col-sm-12 promoteTrack">
                            <div class="pthead clearfix">
                                <div class="value clearfix">
                                    <div class="pull-left">
                                        <select id="promoteTrackSelect"></select>
                                    </div>
                                    <div class="pull-left" style="margin-left: 3px;">
                                        <button id="promoteTrackSearch" type="button">搜索</button>
                                    </div>
                                </div>
                            </div>
                            <div class="ptbody" id="promoteTrack">
        ...
        <div id="page-two" class="rightBodyPage">
            <div id="promoteStatus" class="padding8">
                <div class="promoteStatusTop clearfix">
                    <div class="pull-left selectText" style="width:200px;">
                        <select id="promoteStatusText"></select>
                    </div>
                    <div class="pull-left selectButton">
                        <button id="promoteStatusSearch" type="button">搜索</button>
                    </div>
                    <div class="pull-left selectMore">
                        <span>更多筛选条件<i class="icon-chevron-down"></i></span>
                        <span class="hide">精简筛选条件<i class="icon-chevron-up"></i></span>
                    </div>
                </div>

                <div class="moreSearch hide">
                    <div class="org clearfix">
                        <span class="name orgName">组织架构：</span>
                    ...
                    <div>
                        ...
                        <input id="positionRankText" placeholder="请输入职级" style="width:100px;text-align:left;"/>
                    </div>
                    <div>
                        ...
                        <em>
                            <input id="conditionBegin"/><label>% - </label>
                            <input id="conditionEnd"/>
                            <labeln>%</labeln>
                        </em>
                    </div>
                    <div>
                ...
                <div id="proStatus">
                    <table id="promoteStatusGrid"></table>
                ...
                <div class="sstitle clearfix">
                    <div class="pull-left">
                        ...
                        <i class="icon-question-sign"
                           title="说明：<br><li>默认统计符合条件人员的薪酬变化，您可选择不同晋级人员查看薪酬变化情况；</li><li>晋级后薪酬默认为职级的平均薪酬，您可自定义编辑；</li>"></i>
                    </div>
...
<!-- 符合条件人员 -->
<div class="modal fade" id="applicationConformityModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<!-- 下级组织分析 弹出框-->
<div class="modal fade popup-modal" id="applicationOrganModal" role="dialog" aria-labelledby="applicationOrganLabel" aria-hidden="true">
...
<!-- 薪酬变化模拟器向导 -->
<div class="modal fade" id="messageDialog" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
...
<!-- 薪酬变化模拟器向导 -->
<div class="modal fade" id="emulatorModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
            ...
            <div class="modal-body page-content">
                <div class="content clearfix" style="padding:8px;">
