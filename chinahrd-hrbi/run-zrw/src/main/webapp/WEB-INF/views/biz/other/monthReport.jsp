            ...
            <div class="row ct-row">
                <div class="col-xs-12 right-header">
                    ...
                    <div class="right-header-group">
                        <%--<span class="btn btn-primary btn-block" id="exportBtn">打印</span>--%>
                        <%--<span class="btn btn-primary btn-block" id="favoritesBtn">收藏</span>--%>
                        <%--<span class="btn btn-primary btn-block" id="shareSendingBtn">分享</span>--%>
                        <%--<span class="btn btn-primary btn-block" id="settingBtn">设置</span>--%>
                    </div>
                </div>
            </div>
