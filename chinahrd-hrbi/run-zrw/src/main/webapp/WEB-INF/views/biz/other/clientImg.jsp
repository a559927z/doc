    ...
    <div class="col-xs-2 ct-col1 pull-right" id="settingBlock">
        <div class="panel panel-default setting-main" id="settingMain">
            <div class="panel-body ct-col3" id="setting0">
                ...
                <div class="setting-btns" id="setting0Modal">
                    <span class="btn-layout active" data-toggle="0">关系模式</span>
                    <span class="btn-layout" data-toggle="1">组织模式</span>
                    <span class="btn-layout" data-toggle="2">排序模式</span>
                </div>
            ...
            <div class="panel-body ct-col3 hide" id="setting2">
                <div class="setting-header">
                    <i class="icon-cog"></i>
                    客户销售预测
                </div>
                <div id="conditionMain2"></div>
            </div>
        </div>

        <div class="panel panel-default condition-main col-xs-12 ct-col3 hide" id="conditionBlock">
    ...
    <div class="col-xs-12 ct-col1" id="detailBlock">
        <div class="panel panel-default" id="detail0">
            <div class="panel-body ct-col">
                ...
                <div class="col-xs-8 ct-col1">
                    <div class="col-xs-4 ct-col1" id="manageSalesChart"></div>
                    <div class="col-xs-4 ct-col1" id="manageReturnAmountChart"></div>
                    <div class="col-xs-4 ct-col1" id="manageAnalyzeChart"></div>
                </div>
        ...
        <div class="panel panel-default hide" id="detail1">
            <div class="panel-body ct-col">
                ...
                <div class="col-xs-8 ct-col1">
                    <div class="col-xs-4 ct-col1" id="saleSalesChart"></div>
                    <div class="col-xs-4 ct-col1" id="saleReturnAmountChart"></div>
                    <div class="col-xs-4 ct-col1" id="saleAnalyzeChart"></div>
                </div>
                <div class="col-xs-2 ct-col1">
                    <div class="icon-layout">
        ...
        <div class="panel panel-default hide" id="detail2">
            <div class="panel-body ct-col">
                <div class="col-xs-2 ct-container-fluid">
                    <div class="money-layout">
                        <span class="money-title">购买总额</span>
                        <span class="money-num" id="clientSalesMoney">0</span>
                        <div class="accord-bottom-float-arrow accord-bottom-float-value-rise"></div>
                        <%--<span class="money-unit">万</span>--%>
                    </div>
                    <div class="money-layout">
                        <span class="money-title">销售利润</span>
                        <span class="money-num" id="clientSalesProfit">0</span>
                        <div class="accord-bottom-float-arrow accord-bottom-float-value-drop"></div>
                        <%--<span class="money-unit">万</span>--%>
                    </div>
                    <div class="money-layout">
                        <span class="money-title">回款总额</span>
                        <span class="money-num" id="clientReturnAmount">0</span>
                        <%--<span class="money-unit">万</span>--%>
                    </div>
                </div>
                <div class="col-xs-8 ct-col1">
                    <div class="col-xs-4 ct-col1" id="clientSalesChart"></div>
                    <div class="col-xs-4 ct-col1" id="clientReturnAmountChart"></div>
                    <div class="col-xs-4 ct-col1" id="clientAnalyzeChart"></div>
                </div>
                <div class="col-xs-2 ct-col1">
                    <div class="icon-layout">
                        <span class="img-find"></span>
...
<div class="hide">
    <svg id="svgObj" width="70" height="70" xmlns:xlink="http://www.w3.org/1999/xlink"
         xmlns="http://www.w3.org/2000/svg">
        <g>
            <circle id="bigCircle" cx="35" cy="35" r="34" class="big-circle"/>
            <circle id="smallCircle" cx="92" cy="26" r="12" style="stroke: #d73f38; fill: #d73f38;"/>
            <text id="svgTxt" style="font-size:14pt;fill:#fff;" x="90" y="31">2</text>
        </g>
    </svg>

    <svg id="baseObj" width="450" height="210" xmlns:xlink="http://www.w3.org/1999/xlink"
         xmlns="http://www.w3.org/2000/svg">
        <g>
			<rect id="baseRect" rx="10" ry="10" width="450" height="210" style="opacity:0.8"/>
		</g>
    </svg>
