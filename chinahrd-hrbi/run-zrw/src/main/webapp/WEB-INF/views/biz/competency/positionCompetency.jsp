				...
				<div class="col-sm-3 ct-22 ct-line-col">
					<div class="top-div showview" id="tooltip1" data-toggle="tooltip"
						...
						<div class="index-common-title">
							...
							<div class="index-common-title-right"></div>
						</div>
						<div class="body-div">
					...
					<div class="bottom-div">
						<div class="panelBtn rightdiv teamAvgComBtn">
							<div class="panelBtn_context active">
								...
								<div class="posion_expand panelBtn_expand" id="teamAvgCom_orgain">
<!-- 										<div value="zzzzz" class="option">深圳中心</div> -->
								</div>
							</div>
				...
				<div class="col-sm-6 ct-line-col SetUpBody" view="chart">
					...
					<div class="bottom-div clearfix">
						...
						<div class="row ct-row mainArea">
							...
							<div class="chartArea " id="teamAvgComContrastChart"></div>
						</div>
				...
				<div class="col-sm-12 ct-line-col SetUpBody" view="chart">
					...
					<div class="bottom-div">
						...
						<div class="col-md-6 col-sm-12 col-xs-12 rightPieArea">
							<div class="col-sm-12 preStarBarChar" id="abilityChart"></div>
						</div>
						...
						<div id="chartview-all" class="col-sm-12 ct-line-col two-body-right hide select_tab">
							<div class="col-sm-12 ct-line-col conditionBtnListBody"
								...
								<div class="dis-search">
									...
									</select> <input class="dis-search-input" id="emp_searchTxt" type="text"
						...
						<div id="chartview-g"
							...
							<div class="col-sm-12 ct-line-col conditionBtnListBody">
								<div class="dis-search">
									...
									</select> <input class="dis-search-input" id="position_searchTxt"
								...
								<div class="col-xs-2 ct-col1 top-obj top-left">
									<div class="top-left-text1">
										...
										<div class="top-left-expend">
											...
											<div class="col-sm-12 ">
												<div class="dis-search col-sm-12 select-panel">
													<div class="col-sm-9  select-panel">
...
<!-- 										<div class="contrast-table-switch contrast-table-reduce"></div> -->
			...
			<div class="competency-card">
				...
				<div class="competency-card-panel">
					<div class="position-panel high_dimension_div">
						<span class="position-label">匹配度最高</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
					<div class="position-panel low_dimension_div">
						<span class="position-label">匹配度最低</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
				</div>
				...
				<div class="competency-card-panel">
					<div class="position-panel high_emp_div">
						<span class="position-label">胜任度最高</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
					<div class="position-panel low_emp_div">
						<span class="position-label">胜任度最低</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
				</div>
			...
			<div class="competency-card">
				...
				<div class="competency-card-panel">
					<div class="position-panel high_div">
						<span class="position-label">最高能力</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
					<div class="position-panel low_div">
						<span class="position-label">最低能力</span> <span
							class="position-label-name rate"></span> <span
							class="position-label-name name"></span>
					</div>
				</div>
	...
	<div id="circle_model"  class="custom_model">
		<div class="wrap">
			<canvas class="competency-level-canvas" width="200px" height="200px"></canvas>
		</div>
	</div>
	<!--配置信息 弹出框 begin-->
				...
				<div class="modal-body">
					<div class="form-inline config-modal-row">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" maxlength="3" id="config_high1" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
							<label>%-</label> 
							<input type="text" class="form-control" maxlength="3" id="config_high2" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
							<label>%</label>
						</div>
					...
					<div class="form-inline config-modal-row">
						...
						<div class="form-group">
							<label for="config_middle1">胜任度中：</label>
							 <input type="text" class="form-control" maxlength="3" id="config_middle1" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
							<label>%-</label> 
							<input type="text" class="form-control" maxlength="3" id="config_middle2" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
							<label>%</label>
						</div>
					...
					<div class="form-inline config-modal-row">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" maxlength="3" id="config_low1" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
							<label>%-</label> 
							<input type="text" class="form-control" maxlength="3" id="config_low2" placeholder="请输入0-100的整数"></input>
						</div>
						<div class="form-group">
			...
			<div class="modal-content">
				...
				<div class="row ct-row mainArea">
					<div class="col-sm-12 chart">
						<div class="col-sm-12 " id="ability-dimension-chart"></div>
					</div>
				</div>
			</div>
			<!-- /.modal-content -->
