...
<div class="human-inventory" id="trainBoard">
    ...
    <div class="rightBody rightBody10">
		...
		<div id="page-two" class="rightBodyPage">
			<div class="col-sm-12 SetUpBody padding10" view="employee">
...
<div class="modal fade popup-modal" id="manpowerInYearModal" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="inlineBlock lineHeight30 marginBottom20">
                	<div class="left">时间：</div>
               		<div class="left myTimes marginLeft10 bord-style" id="manpowerTimes"></div>
                	<div class="left marginLeft10">项目名称：</div>
                	<div class="left marginLeft10"><select id="manpowerProjectNames"></select></div>
               		<div class="left marginLeft10">人力总投入：<span id="manpowerTotal"></span>人</div>
                </div>
                <ul class="nav nav-tabs f-white-bg zIndex0" role="tablist" id="manpowerTabs">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
               	<div class="inlineBlock lineHeight30 marginBottom20">
                	<div class="left">时间：</div>
               		<div class="left myTimes marginLeft10 bord-style" id="costTimes"></div>
                	<div class="left marginLeft10">项目名称：</div>
                	<div class="left marginLeft10"><select id="costProjectNames"></select></div>
               		<div class="left marginLeft10">费用总投入：<span id="costTotal"></span>万元</div>
                </div>
                <ul class="nav nav-tabs f-white-bg zIndex0" role="tablist" id="feeInputTabs">
...
<!-- 本年投入费用 弹出框 end -->
<!-- 本年利润  弹出框 begin -->
<div class="modal fade popup-modal" id="profitYearModal" tabindex="-1" role="dialog"
     aria-labelledby="profitYearLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-header-text" id="profitYearLabel">主导项目利润趋势</div>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
                <div class="inlineBlock lineHeight30">
                	<div class="left">时间：</div>
               		<div class="left myTimes marginLeft10 bord-style" id="profitTimes"></div>
                	<div class="left marginLeft10">项目名称：</div>
                	<div class="left marginLeft10"><select id="profitProjectNames"></select></div>
               		<div class="left marginLeft10">总利润：<span id="profitTotal"></span>万元</div>
                </div>
                <div class="height350 width100p" id="profitYearChart"></div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
               	<div class="inlineBlock lineHeight30 marginBottom20">
                	<div class="left">时间：</div>
               		<div class="left myTimes marginLeft10 bord-style" id="partakeManpowerTimes"></div>
                	<div class="left marginLeft10">项目名称：</div>
                	<div class="left marginLeft10"><select id="partakeManpowerProjectNames"></select></div>
               		<div class="left marginLeft10">人力总投入：<span id="partakeManpowerTotal"></span>人</div>
                </div>
                <ul class="nav nav-tabs f-white-bg zIndex0" role="tablist" id="partManpoerInputTabs">
			                ...
			                <div class="col-sm-6 SetUpBody" view="chart">
			                    ...
			                    <div class="bord-style">
			                        <div class="chart-view textAlignCenter height334">
			                            ...
			                            <div id="partWorkspaceInputText" class="pieChartText hide">
			                            	<div class="pieChartTextContent">
	                                            <div>工作地</div>
	                                            <div class="legend">-</div>
			                            	</div>
