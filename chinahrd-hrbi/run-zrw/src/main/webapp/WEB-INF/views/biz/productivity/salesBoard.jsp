	...
	<div class="rightBody rightBody10">
					...
					<div class="body-div" id="perfDismissArea">
						...
						<div class="accord-bottom-float">
							<div class="accord-bottom-float-text">
								较上月下降<span id="salesValCompare"></span>%
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-4 ct-line-col" view="chart">
				<div class="index-common-title bottom-title">
					...
					<div class="index-common-title-text bottom-text">团队排行榜
						<i class="icon-question-sign bigger-140" title="销售额排行榜，统计单位为万元。"></i>
					</div>
				...
				<div class="index-common-title bottom-title bottom-title-right">
					<div class="index-common-title-left bottom-left"></div>
        ...
        <div id="page-two" class="rightBodyPage">
			<div class="col-sm-12 ct-container-fluid SetUpBody" view="chart">
				...
				<div class="bottom-div">
					...
					<div class="chart-view chart-view-Trend">
						<div class="col-xs-12 bottom-div-first">
							<span id="salesTypeName">销售额</span>
						</div>
						<div class="col-xs-12" id="salesTrendChart"></div>
					</div>
			...
			<div class="col-sm-12 ct-container-fluid SetUpBody" view="chart">
				...
				<div class="bottom-div nav-btn" view="team">
					<div class="nav-title">
						<div class="nav-title-text nav-title-text-selected">团队</div>
						<div class="nav-title-text" id="personSlected">个人</div>
					</div>
					<div class="team-view">
						<div class="col-xs-12">
							<!-- <div style="margin-top: 10px; float: left;"><select id="teamTime"></select></div> -->
							<div class="row left">
								<div id="teamTime"></div>
							</div>
							<div class="row moreSearch left" id="moreSearch">
								<label class="more-search-label icon-panel-down" id="teamMoreLabel">更多筛选条件</label>
							</div>
							<form id="teamConditionSearchForm" class="conditionSearchForm" action="">
								<div class="condition-body" id="employeeCondition" style="display: none;">
									...
									<div class="condition-body-list condition-body-list-too">
										...
										<select class="condition-input-text left" id="subOrgan"></select>
									</div>
									<div class="condition-body-list condition-body-list-too">
									...
									<div class="condition-body-list">
										...
										<input type="text" id="beginSales" class="condition-input-text left" />
										<span class="condition-text-one left">万元</span>
										<span class="condition-text-one left">-</span>
										<input type="text" id="endSales" class="condition-input-text condition-input-text-too left" />
										<span class="condition-text-one left">万元</span>
									</div>
									<div class="condition-body-list">
										<div class="condition-body-list-title left">回款额：</div>
										<input type="text" id="beginReturnAmount" class="condition-input-text left" />
										<span class="condition-text-one left">万元</span>
										<span class="condition-text-one left">-</span>
										<input type="text" id="endReturnAmount" class="condition-input-text condition-input-text-too left" />
										<span class="condition-text-one left">万元</span>
									</div>
						...
						<!-- <div class="col-xs-12 m-top" id="teamView"></div> -->
						<div class="cardTabel" id="teamView_tabel"></div>
					</div>
					<div class="person-view">
						<div class="col-xs-12">
							<!-- <div class="left" style="margin-top: 10px;"><select><option>2016年1月</option></select></div> -->
							<div class="row left">
								<div id="personTime"></div>
							</div>
							...
							<div class="row left" id="moreSearch">
								<label class="more-search-label icon-panel-down" id="personMoreLabel">更多筛选条件</label>
							</div>
							<form id="personConditionSearchForm" class="conditionSearchForm" action="">
								<div class="condition-body" style="display: none;">
									...
									<div class="condition-body-list">
										<div class="condition-body-list-title left">销售额：</div>
										<input type="text" id="beginPersonSales" class="condition-input-text left" />
										<span class="condition-text-one left">万元</span>
										<span class="condition-text-one left">-</span>
										<input type="text" id="endPersonSales" class="condition-input-text condition-input-text-too left" />
										<span class="condition-text-one left">万元</span>
									</div>
									<div class="condition-body-list">
										<div class="condition-body-list-title left">回款额：</div>
										<input type="text" id="beginPersonAmount" class="condition-input-text left" />
										<span class="condition-text-one left">万元</span>
										<span class="condition-text-one left">-</span>
										<input type="text" id="endPersonAmount" class="condition-input-text condition-input-text-too left" />
										<span class="condition-text-one left">万元</span>
									</div>
									<div class="condition-body-bottom">
						...
						<div class="clearfix"></div>
						<!-- <div class="col-xs-12 m-top" id="personView"></div> -->
        ...
        <div id="page-three" class="rightBodyPage">
			<div class="col-sm-12 ct-container-fluid SetUpBody" view="chart-1">
				...
				<div class="bottom-div-three height600">
					...
					<div class="chart-view-2 maps-pk-div">
						<div class="" id="maps-pk-one">
							<div class="maps-pk-title">你可直接选择下级团队查看不同团队的销售排名地图</div>
						...
						<div class="hide" id="maps-pk-three">
							...
							<div class="maps-ts hide" id="pkInfo">
								<img src="${ctx}/assets/img/widgets/notify_info.png">
								<span>为保证显示效果，地图隐藏部分人员。如需查看所有人员，请点击
		...
		<div class="bottom-detail">
			...
			<div class="bottom-bar">
				<div style="margin-top: 10px;">
					...
					<div class="progress teamSalesBack">
						<div class="progress-bar progress-bar-info" role="progressbar"
							 aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
						</div>
					</div>
	...
	<div class="card-table-td">
		<div class="bottom-detail">
			...
			<div class="bottom-bar">
				<div style="margin-top: 10px;">
					<div class="bar-span left">销售额/目标额</div>
					<div class="progress personSales">
						<div class="progress-bar progress-bar-info" role="progressbar"
							 aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
							 >
						</div>
			...
			<div class="bottom-bar">
				<div style="margin-top: 10px;">
					<div class="bar-span left">已回款/回款额</div>
					<div class="progress personSalesBack">
						<div class="progress-bar progress-bar-info" role="progressbar"
							 aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
							 style="width: 30%;">
						</div>
				...
				<div class="tab-content" style="padding-left:0px;">
					<div role="tabpanel" class="tab-pane active">
						<div class="row ct-row">
							<div class="col-xs-6" id="salesValTable">
							...
							<div class="col-xs-6" id="exceptionOrganTable">
						...
						<div class="row ct-row">
							<div class="col-xs-6" id="inputOutputExceptionTable">
							...
							<div class="col-xs-6" id="abilityCheckTable">
			...
			<div class="modal-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10 ct-col1"><div class="col-sm-6 ct-col1"><ul class="ztree" id="organZtree"></ul><i id="organRemovebtn" class="icon-remove hide"></i></div></div>
					</div>
					<!-- <div class="form-group">
