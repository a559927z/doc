                    ...
                    <div class="bottom-div-two">
                        <div class="col-sm-12 ct-line-col conditionBtnListBody" id="searchBox">
                            <div class="dis-search">
                                ...
                                <div class="clear-on dis-search-input-btn" id="setCalendarBtn">设置假期</div>
                                <div class="clear-on dis-search-input-btn" id="exportBtnId">导出</div>
                            </div>
                        </div>
...
<!-- 月度考勤表导出弹窗 begin -->
<div class="modal fade popup-modal" id="exportAttendanceMonthlyModal" tabindex="-1" role="dialog" aria-labelledby="exportAttendanceMonthlyLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title" id="exportAttendanceMonthlyLabel">导出月度考勤表</div>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
				<div class="h5"></div>
                <div class="lead" id="monthSelect"></div>
                
                <div class="modal-title-point">
                    （操作提示：选择需要的月度，点击确定即可导出月度考勤表）
                </div>
			</div>
		</div>
	</div>
...
<!-- 月度考勤表导出弹窗 end -->
<div class="modal fade popup-modal" id="exportAttendanceMonthlyExportingModal" tabindex="-1" role="dialog" aria-labelledby="exportAttendanceMonthlyExportingLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title" id="exportAttendanceMonthlyExportingLabel">正在导出...请等待excel文件下载</div>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
		</div>
	</div>
...
<script src="${jsRoot}biz/competency/laborEfficiency.js"></script>
 ...
 <%@include file="/WEB-INF/views/include/calendar.jsp" %>
</body>
</html>
