...
public class PlatformGenerator {
    ...
    // 模块名
    private static final String module_name = "pub";

    // 表统一前缀，一般建议同模块表用模块名做前缀
    private static final String table_prefix = "pub";

    // 表名，可一次多个
    private static final String[] table_include = new String[] {"pub_log_info"};
    ...
    public static void main(String[] args) {
        ...
        // 自定义实体，公共字段
        strategy.setSuperEntityColumns(new String[]{"create_by", "create_date", "update_by", "update_date", "revision"});
